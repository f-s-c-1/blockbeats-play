...
`dev` 和 `preview` 都绑定 `0.0.0.0:53917`，方便同一局域网内手机访问。局域网访问时把 `127.0.0.1` 换成电脑的局域网 IP。

## 常用入口

```text
http://127.0.0.1:53917/admin
http://127.0.0.1:53917/r/房间码
```
...
`test:smoke` 默认连接 `ws://127.0.0.1:53917/ws`，运行前需要先启动 `pnpm dev`。
